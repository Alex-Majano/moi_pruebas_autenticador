...
let BitacoraService = class BitacoraService {
    constructor(bitLogErroresRepository) {
        this.bitLogErroresRepository = bitLogErroresRepository;
    }
    async create(createBitacoraDto) {
        const { user: userId } = createBitacoraDto, data = __rest(createBitacoraDto, ["user"]);
        const bitacora = this.bitLogErroresRepository.create(Object.assign({ id: (0, uuid_1.v4)(), user: userId }, data));
...
exports.BitacoraService = BitacoraService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(bitLogsErrors_entity_1.BitLogErrores)),
